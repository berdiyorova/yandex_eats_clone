...
class OwnerDeliverySerializer(serializers.ModelSerializer):
    ...
    def validate_user_role(self, value):
        if value not in [UserRole.OWNER, UserRole.DELIVERY]:
            raise serializers.ValidationError("User role must be only OWNER or DELIVERY.")
...
class ManagerSerializer(serializers.ModelSerializer):
    ...
    def validate_user_role(self, value):
        if value != UserRole.MANAGER:
            raise serializers.ValidationError("User role must be only MANAGER.")
